...
CREATE TABLE PERROS(
    ...
    FOREIGN KEY(APODERADO_ID) REFERENCES APODERADOS(ID) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE CONSULTAS(
    ...
    INSPECCION MEDIUMBLOB NOT NULL,
    RESULTADOS TEXT(100) NOT NULL,

    FOREIGN KEY(PERRO_ID) REFERENCES PERROS(ID) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY(VETERINARIO_ID) REFERENCES USUARIOS(ID) ON DELETE CASCADE ON UPDATE CASCADE
);
